...
template <class T>
class lipp_LinearModel
{
public:
    double a = 0; // slope
    long double b = 0; // intercept

    lipp_LinearModel() = default;
    lipp_LinearModel(double a, long double b) : a(a), b(b) {}
    explicit lipp_LinearModel(const lipp_LinearModel &other) : a(other.a), b(other.b) {}
